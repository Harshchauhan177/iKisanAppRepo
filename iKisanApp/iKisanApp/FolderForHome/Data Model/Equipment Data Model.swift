...
struct ReviewData{
    ...
    static var reviews: [ReviewData] = [
        ReviewData(reviewHeading: "Excellent", reviewDescription: "Description", rating: 4),
        ReviewData(reviewHeading: "Good", reviewDescription: "Description", rating: 3),
        ReviewData(reviewHeading: "Bad", reviewDescription: "Description", rating: 2),
        ReviewData(reviewHeading: "Very Bad", reviewDescription: "Description", rating: 1),
